<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Masterpages/1.master" CodeBehind="Wfrm_EN_RequerimientoExp.aspx.vb" Inherits="Portalv9.Wfrm_EN_RequerimientoExp" %>
     ...
     <dxwgv:ASPxGridView ID="ASPxGridView1" runat="server" Visible="False" 
         ...
         <Columns>
             <dxwgv:GridViewDataHyperLinkColumn VisibleIndex="0">
                 <DataItemTemplate>
                     <dxe:ASPxButton ID="btnSolicitar" runat="server" CommandName="Solicitar"  
                         Text="Solicitar" Width="58px" CommandArgument='<%# Bind("Llave_expediente") %>'>
                     </dxe:ASPxButton>
                 </DataItemTemplate>
             </dxwgv:GridViewDataHyperLinkColumn>
             <dxwgv:GridViewDataTextColumn Caption="Campo" 
                 FieldName="Indice" VisibleIndex="1" ToolTip="Indice en el que se encontro">
             </dxwgv:GridViewDataTextColumn>
             <dxwgv:GridViewDataTextColumn Caption="Valor" FieldName="valor" 
                 VisibleIndex="2" ToolTip="Valor encontrado en la Busqueda">
             </dxwgv:GridViewDataTextColumn>
             ...
             <dxwgv:GridViewDataTextColumn Caption="Indices" 
                 FieldName="Indice_de_busqueda" VisibleIndex="4" 
                 ToolTip="Indice de búsqueda">
             </dxwgv:GridViewDataTextColumn>
             ...
             <dxwgv:GridViewDataTextColumn Caption="Solicita" FieldName="Usuario_Solicita" 
                 VisibleIndex="6" ToolTip="Usuario que solicitó">
             </dxwgv:GridViewDataTextColumn>
             <dxwgv:GridViewDataTextColumn Caption="Entidad" FieldName="Entidad" 
                 VisibleIndex="7" ToolTip="Entidad a la que pertenece">
             </dxwgv:GridViewDataTextColumn>
             <dxwgv:GridViewDataTextColumn Caption="Area" FieldName="Area" VisibleIndex="8" 
                 ToolTip="Area Administrativa a la que pertenece">
             </dxwgv:GridViewDataTextColumn>
         </Columns>
     </dxwgv:ASPxGridView>

<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Wfrm_TE_FormatoLiberacion.aspx.vb" Inherits="Portalv9.Wfrm_TE_FormatoLiberacion" %>
				...
				<TR>
					<TD style="HEIGHT: 2px" width="70%">
						<asp:label id="lblTitle" runat="server" Font-Italic="True" Font-Bold="True" Width="544px" Height="5px"
							Font-Size="10pt" Font-Names="Arial">Acta de liberación de folios faltantes</asp:label>
					...
					<TD vAlign="top" colSpan="2">
						<DIV align="center">
							<TABLE id="Table2" style="WIDTH: 762px; HEIGHT: 152px" cellSpacing="0" cellPadding="0"
								...
								<TR>
									<TD style="WIDTH: 211px; HEIGHT: 16px" vAlign="middle" align="right"><B><FONT face="Arial, Helvetica, sans-serif" color="#000000" size="2">Solicitó 
												el envío:&nbsp;</FONT></B></TD>
								...
								<TR>
									<TD style="WIDTH: 211px; HEIGHT: 8px" vAlign="middle" align="right"><B><FONT face="Arial, Helvetica, sans-serif" color="white" size="2"><B><FONT face="Arial, Helvetica, sans-serif" color="#000000" size="2"><B><FONT face="Arial, Helvetica, sans-serif" color="#ffffff" size="2"><B><FONT face="Arial, Helvetica, sans-serif" color="#000000" size="2"><B><FONT face="Arial, Helvetica, sans-serif" color="#000000" size="2">
																				Variación&nbsp;:&nbsp;</FONT></B></FONT></B></FONT></B></FONT></B>
											</FONT></B>
									</TD>
									<TD style="HEIGHT: 8px" vAlign="middle">
										<asp:label id="lblSobrante" runat="server" Width="528px" Font-Size="10pt" Font-Names="Arial"></asp:label></TD>
								</TR>
								<TR>
									<TD style="WIDTH: 211px; HEIGHT: 8px" vAlign="middle" align="right"></TD>
									<TD style="HEIGHT: 8px" vAlign="middle"></TD>

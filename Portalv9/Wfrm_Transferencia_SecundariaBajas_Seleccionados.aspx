<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Masterpages/Adminmaster2col.master" CodeBehind="Wfrm_Transferencia_SecundariaBajas_Seleccionados.aspx.vb" Inherits="Portalv9.Wfrm_Transferencia_SecundariaBajas_Seleccionados" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <dxe:ASPxHyperLink ID="Regresar" runat="server" ImageUrl="~/Images/regresar.gif" 
            NavigateUrl="~/Wfrm_Transferencia_SecundariaBajas.aspx" />
        ...
        <tr>
            <td valign="top" colspan="2" style="text-align: right">
                <dxe:ASPxButton ID="butRepAutorizacion" runat="server" 
                    Text="Reporte de bajas" Width="190px"></dxe:ASPxButton>
            </td>
        </tr>
        <tr>
            ...
            <td valign="top">
                <dxe:ASPxButton ID="butAceptar" runat="server" Text="Generar Baja" 
                    Width="160px">
                </dxe:ASPxButton>
            </td>
        </tr>

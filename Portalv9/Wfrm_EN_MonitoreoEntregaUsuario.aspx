<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Masterpages/1.master" CodeBehind="Wfrm_EN_MonitoreoEntregaUsuario.aspx.vb" Inherits="Portalv9.Wfrm_EN_MonitoreoEntregaUsuario" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <dxwgv:ASPxGridView ID="ASPxGridView1" runat="server" 
        ...
        <SettingsText Title="Consulta --&gt; Oficinas/Monitoreo de folios por entregar al usuario" />
        <Columns>
    ...
    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" 
        ...
        <SelectParameters>
            <asp:Parameter DefaultValue="55" Name="pintEstadoID" Type="Int32" />
        </SelectParameters>

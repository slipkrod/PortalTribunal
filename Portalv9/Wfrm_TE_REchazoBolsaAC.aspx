<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Masterpages/1.master" CodeBehind="Wfrm_TE_REchazoBolsaAC.aspx.vb" Inherits="Portalv9.Wfrm_TE_REchazoBolsaAC" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <table id="Table1" border="1" 
        ...
        <tr>
            <td style="HEIGHT: 8px;" >
                <asp:Label ID="lblTitle" runat="server" Font-Bold="True" Font-Italic="True" 
                    Font-Names="Arial" Font-Size="10pt" Height="16px" Width="606px"> Envío-&gt;Archivo Central/Rechazo de folioEnvío-&gt;Centro de distribución/Rechazo de folio</asp:Label>
            </td>
        </tr>
        <tr>
            <td valign="top" >
        ...
        SelectMethod="BuscaInstanciaExpedientexEstadoxBolsa" 
                ...
                Type="String" />
                        <asp:Parameter DefaultValue="8" Name="EstadoID" Type="Int32" />
                    </SelectParameters>

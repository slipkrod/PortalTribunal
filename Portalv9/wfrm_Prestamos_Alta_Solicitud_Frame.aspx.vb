...
Partial Public Class wfrmPrestamosAltaSolicitudFrame
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            Dim idExpediente As Integer = CType(Request("idDescripcion"), Integer)

            If (idExpediente <= 0) Then
                idExpediente = CType(Session("idExpediente"), Integer)
            End If
            ...
            If idExpediente > 0 Then
                ...
                If (sv.CuentaSolicitudesExpedienteEstatus(idDescripcion, 3) > 0) Then

                    LabelPrestado.Visible = True

                    fechaDevolucion = CType(sv.ObtenFechaDevolucionExpedientePrestado(idDescripcion), Date).ToShortDateString()
                    LabelPrestado.Text += fechaDevolucion
                End If

<%@ Page Language="vb" AutoEventWireup="false" AspCompat="true" CodeBehind="Wfrm_ReporteExpedientesConfidenciales.aspx.vb" MasterPageFile="~/Masterpages/Adminmaster2col.master" Inherits="Portalv9.Wfrm_ReporteExpedientesConfidenciales" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <dxxr:ReportToolbar ID="ReportToolcgca" runat='server' ShowDefaultButtons='False' 
            ReportViewer="<%# ReportExpedientesConfidenciales %>" >
        <Items>
    ...
    <dxxr:ReportViewer ID="ReportExpedientesConfidenciales" runat="server" 
            ReportName="Portalv9.RPT_ExpedientesConfidenciales" >
    </dxxr:ReportViewer>

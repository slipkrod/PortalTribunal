...
Partial Public Class Wfrm_TE_FormatoLiberacion
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            ...
            If ds.Tables(0).Rows(0).Item("Variacion") Is DBNull.Value Then
                lblSobrante.Text = ""
            Else
                lblSobrante.Text = ds.Tables(0).Rows(0).Item("Variacion")
            End If

            If ds.Tables(0).Rows(0).Item("Observaciones") Is DBNull.Value Then

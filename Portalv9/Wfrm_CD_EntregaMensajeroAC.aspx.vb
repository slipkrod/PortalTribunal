...
Partial Public Class Wfrm_CD_EntregaMensajeroAC
    Inherits System.Web.UI.Page
    Private Const estadoenvio As Integer = 6
    Private Const eventoOKenvio As Integer = 8
    Private Const estadoSolicitud As Integer = 53
    Private Const eventoOKSolicitud As Integer = 53
    Private Const estadorecol As Integer = 84
    Private Const eventoOKrecol As Integer = 86
                ...
                Else
                    Select Case dsBolsa.Tables(0).Rows(0).Item("EstadoID")
                        Case 6
                            ...
                            newItem.Value = eventoOKenvio
                            lbbolsas.Items.Add(newItem)
                            txtfbolsa.Text = ""
                            SetFocus(txtfbolsa)
                        Case 53
                            newItem.Text = txtfbolsa.Text
                            newItem.Value = eventoOKSolicitud
                            lbbolsas.Items.Add(newItem)
                            txtfbolsa.Text = ""
                            SetFocus(txtfbolsa)
                        Case 84
                            newItem.Text = txtfbolsa.Text
                            newItem.Value = eventoOKrecol
                            lbbolsas.Items.Add(newItem)
                            txtfbolsa.Text = ""
                            SetFocus(txtfbolsa)
                        Case Else
                            lblerror.Text = "La bolsa no se encuentra en centro de distribución para entrega a mensajería..."
                    End Select
                End If
            End If
        End If
            ...
            If (txtmensajeria.Text <> "") Then
                ...
                If IsValid Then
                    ...
                    If lbbolsas.Items.Count > 0 Then
                        ...
                        rsAtributos = svr.Obten_Atributos(eventoOKenvio, "Valija")

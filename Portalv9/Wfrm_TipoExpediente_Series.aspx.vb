...
Partial Public Class Wfrm_TipoExpediente_Series
    ...
    Private Sub dsLista_SeriesModelo_Hijos_Inserted(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.ObjectDataSourceStatusEventArgs) Handles dsLista_SeriesModelo_Hijos.Inserted

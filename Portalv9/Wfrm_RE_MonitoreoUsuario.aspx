<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Masterpages/1.master" CodeBehind="Wfrm_RE_MonitoreoUsuario.aspx.vb" Inherits="Portalv9.Wfrm_RE_MonitoreoUsuario" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    DataSourceID="ObjectDataSource1" EnableTheming="False" 
        ...
        <SettingsText Title="Recolección  de expedientes" />
        <Columns>
...
<asp:ObjectDataSource ID="ObjectDataSource1" runat="server" 
    SelectMethod="Monitoreo_RecoleccionxUsuario" 
    ...
    <asp:ObjectDataSource ID="ObjectDataSource2" runat="server" 
        SelectMethod="Monitoreo_FoliosFaltantesRecoleccionxUsuario" 
        TypeName="Portalv9.SAEX.ServiciosSAEX" 
        OldValuesParameterFormatString="original_{0}">
        <SelectParameters>

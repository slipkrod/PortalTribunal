<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Masterpages/Adminmaster2col.master" CodeBehind="Wfrm_ValorizacionBajas.aspx.vb" Inherits="Portalv9.Wfrm_ValorizacionBajas" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div>
    <asp:label id="lblTitle" runat="server" Font-Size="Small" Height="16px" Font-Names="Arial" Font-Bold="True" Font-Italic="True">Bajas documentales</asp:label>
</div>
<br />
        ...
        <tr>
            <td>
                <dxwgv:ASPxGridView ID="gdTransferenciaActiva" runat="server" ClientInstanceName="grid" 
                    ...
                    <SettingsText Title="Bajas documentales activas" CommandEdit="Editar" 
                        CommandNew="Nuevo" EmptyDataRow="No existen registros" 
                        CommandCancel="Cancelar" CommandUpdate="Actualizar" />
                    <Columns>
                        ...
                        <dxwgv:GridViewDataComboBoxColumn Caption="Archivo de Tramite" FieldName="idArchivoOrigen" 
                            VisibleIndex="3">
                        ...
                        <dxwgv:GridViewDataTextColumn Caption="Detalle" VisibleIndex="6" Width="50px">
        ...
        <tr>
            <td valign="top">
                <dxwgv:ASPxGridView ID="gdTransferencaHist" runat="server" ClientInstanceName="grid" 
                    ...
                    KeyFieldName="idFolio" EnableCallBacks="False">
                    <SettingsBehavior ProcessFocusedRowChangedOnServer="true" />
                    <SettingsText Title="Histórico de bajas documentales" 
                    ...
                    <Columns>
                        ...
                        <dxwgv:GridViewDataDateColumn Caption="Fecha de Transferencia" 
                            FieldName="Fecha_Aplicacion" VisibleIndex="3">
                        </dxwgv:GridViewDataDateColumn>
                        <dxwgv:GridViewDataComboBoxColumn Caption="Archivo Trámite" 
                            FieldName="idArchivoOrigen" VisibleIndex="2">
                        ...
                        <dxwgv:GridViewDataTextColumn Caption="Detalle" VisibleIndex="6">
                            <DataItemTemplate>
    ...
    <asp:ObjectDataSource ID="dsTransferenciaActiva" runat="server" 
            SelectMethod="ListaBajas_Tramite" 
        TypeName="Portalv9.WSArchivo.Service1" 
        InsertMethod="ABC_Transferencias_Primarias_Bajas" 
        UpdateMethod="ABC_Transferencias_Primarias_Bajas" 
        DeleteMethod="ABC_Transferencias_Primarias_Bajas">
        <DeleteParameters>
        ...
        <UpdateParameters>
            ...
            <asp:Parameter DefaultValue="" Name="idFolio" Type="Int32" />
            <asp:Parameter Name="Usrid" Type="Int32" DefaultValue="" />
            <asp:Parameter Name="Fecha_Solicitud" Type="DateTime" />
            <asp:Parameter Name="idArchivoOrigen" Type="Int32" />
            <asp:Parameter Name="Notas_Solicitud" Type="String" />
        ...
        <InsertParameters>
            ...
            <asp:Parameter Name="idFolio" Type="Int32" DefaultValue="" />
            <asp:Parameter Name="Usrid" Type="Int32" />
            <asp:Parameter Name="Fecha_Solicitud" Type="DateTime" />
            <asp:Parameter Name="idArchivoOrigen" Type="Int32" />
            <asp:Parameter Name="Notas_Solicitud" Type="String" />
    ...
    <asp:ObjectDataSource ID="dsArchivosTipo" runat="server" 
        ...
        TypeName="Portalv9.WSArchivo.Service1">
        <SelectParameters>
            <asp:Parameter DefaultValue="0" Name="Tipo_Archivo" Type="Int32" />
        </SelectParameters>
    </asp:ObjectDataSource>
    <asp:ObjectDataSource ID="dsArchivosConcentracion" runat="server" 
            SelectMethod="ListaArchivos_Tipo" TypeName="Portalv9.WSArchivo.Service1" 
        OldValuesParameterFormatString="original_{0}">
        <SelectParameters>

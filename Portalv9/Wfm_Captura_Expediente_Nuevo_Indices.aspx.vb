Partial Public Class Wfm_Captura_Expediente_Nuevo_Indices
    ...
    Protected Sub aspxCancelar_Click(ByVal sender As Object, ByVal e As EventArgs) Handles aspxCancelar.Click
        Response.Redirect("Wfm_Captura_Expediente_Serie.aspx?idArchivo=" & Request.QueryString("idArchivo") & "&idNorma=" & Request.QueryString("idNorma") & "&idNivel=8")
    End Sub
    ...
    Protected Sub aspxguardar_Click(ByVal sender As Object, ByVal e As EventArgs) Handles aspxguardar.Click
        ...
        Try
            ...
            For intI = 0 To dsNomraCampos.Tables(0).Rows.Count - 1
                ...
                End If
            Next
            NewURL = "Wfm_Captura_Expediente_Documentos.aspx?idArchivo=" & Request.QueryString("idArchivo") & "&idDescripcion=" & newidDescripcionPID & "&idSerie=" & Request.QueryString("idSerie") & "&idNorma=" & Request.QueryString("idNorma")
            Response.Write("<script language='javascript'>self.parent.location='" & NewURL & "';</script>")
    ...
    Private Sub InsertaenArbol()
        ...
        daArbolPadre.InsertParameters("idTipoElemento").DefaultValue = 1

...
Partial Public Class Wfrm_PlantillaArchivoBak
    ...
    Protected Sub Tipo_SelectedIndexChanged(ByVal sender As Object, ByVal e As EventArgs) Handles Tipo.SelectedIndexChanged
        Select Case Tipo.SelectedItem.Value
            Case 0
    ...
    Protected Sub ASPxButton2_Click(ByVal sender As Object, ByVal e As EventArgs) Handles ASPxButton2.Click
        ...
        Select Case lblEstado.Text
            Case "Editar"
                sv.ABC_Archivo_Elementos_Campos(WSArchivo.OperacionesABC.operCambio, lblElementoID.Text, lblidIndice.Text, CampoNombre.Text, Tipo.SelectedItem.Value, Longitud.Text, Mascara.Text, Obligatorio.Checked, 0, 1, 0, 0, 0, vVisible.Checked, 0, 0, 0)
                ASPxError.Text = "Se ejecutó correctamente la operación de editar solicitada. "
            Case "Add"
                sv.ABC_Archivo_Elementos_Campos(WSArchivo.OperacionesABC.operAlta, lblElementoID.Text, 0, CampoNombre.Text, Tipo.SelectedItem.Value, Longitud.Text, Mascara.Text, Obligatorio.Checked, 0, 1, 0, 0, 0, vVisible.Checked, 0, 0, 0)

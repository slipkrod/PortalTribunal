<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Masterpages/1.master" CodeBehind="WebForm1.aspx.vb" Inherits="Portalv9.WebForm1" %>
...
<div id="pagetitle">
<asp:Label ID="Label1" runat="server" Text="Consulta->Usuario/Monitoreo de requerimientos"> </asp:Label>
</div>
</asp:Content>
...
<asp:ObjectDataSource ID="ObjectDataSource1" runat="server" 
    ...
    <dxwgv:ASPxGridView ID="ASPxGridView2" runat="server" 
        ...
        AutoGenerateColumns="False" Font-Size="XX-Small" Visible="False">

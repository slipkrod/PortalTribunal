<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPages/1.master" CodeBehind="Wfrm_Admin_RptAdminUsrXGrupo.aspx.vb" Inherits="Portalv9.Wfrm_RptAdminUsrXGrupo" 
    title="Reporte - Usuarios por Grupo " %>
            ...
            <tr>
                ...
                <td class="style4">
                    <asp:Label ID="Label6" runat="server" Font-Names="Arial" Font-Size="10pt" 
                        Width="135px">&nbsp;Seleccione Grupo:</asp:Label>
                </td>
                <td class="style26">
                    <asp:DropDownList ID="ddlGrupos" runat="server" Font-Names="Arial" 
                    ...
                    <asp:DataGrid ID="grdReporte" runat="server" AllowPaging="True" 
                        ...
                        <Columns>
                            ...
                            <asp:BoundColumn DataField="" 
                                HeaderText="" >
                                <ItemStyle Width="10px" Font-Bold="False" Font-Italic="False" Font-Overline="False" 
                                    Font-Size="X-Small" Font-Strikeout="False" Font-Underline="False" 
                                    />
                            </asp:BoundColumn>
                            
                            <asp:BoundColumn DataField="NombrePerfil" 
                                HeaderText="" HeaderStyle-Font-Size="10pt" >
                                <ItemStyle Font-Bold="False" Font-Italic="False" Font-Overline="False" 
                                    Font-Size="X-Small" Font-Strikeout="False" Font-Underline="False" 
                                     />

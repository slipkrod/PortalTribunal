<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Masterpages/1.master" CodeBehind="Wfrm_CD_recepfolios.aspx.vb" Inherits="Portalv9.Wfrm_CD_recepfolios" %>
<asp:Content ID="Content1" ContentPlaceHolderID="TituloBarra" runat="server">
<div id="pagetitle">
<asp:Label ID="Label3" runat="server" Text="Centro de distribución / Recepción de folios"> </asp:Label>
</div>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table  style="width: 80%; border: 1px solid #A3C0E8">
        <tr>
        ...
        <tr>
            <td style="height: 21px; width: 177px; text-align: right;">
                <asp:Label ID="lblForaneo" runat="server" Text="¿Foráneo?" 
                    ForeColor="#3F5DBC" style="text-align: right" Visible="False"></asp:Label>
                </td>
            <td style="height: 21px; text-align: left;">
                <asp:CheckBox ID="chkBolsaForanea" runat="server" Visible="False" />
            </td>
        </tr>
        <tr>

...
Partial Public Class Wfrm_AC_Monitoreo
    Inherits System.Web.UI.Page
    Private Const estadoenvio As Integer = 10
    Private Const estadorecoleccion As Integer = 86
    Private Const eventoError As Integer = 11
    Private Const eventoFoliosFalt As Integer = 9

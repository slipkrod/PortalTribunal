<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Masterpages/Adminmaster2col.master" CodeBehind="Wfrm_Valorizacion.aspx.vb" Inherits="Portalv9.Wfrm_Valorizacion" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div>
    <asp:label id="lblTitle" runat="server" Font-Size="Small" Height="16px" Font-Names="Arial" Font-Bold="True" Font-Italic="True">Transferencias Primarias</asp:label>
</div>
<br />
        ...
        <tr>
            <td>
                <dxwgv:ASPxGridView ID="gdTransferenciaActiva" runat="server" ClientInstanceName="grid" 
                    ...
                    <SettingsText Title="Transferencia primaria activa" CommandEdit="Editar" 
        ...
        <tr>
            <td valign="top">
                <dxwgv:ASPxGridView ID="gdTransferencaHist" runat="server" ClientInstanceName="grid" 
                    ...
                    KeyFieldName="idFolio" EnableCallBacks="False">
                    <SettingsBehavior ProcessFocusedRowChangedOnServer="true" />
                    <SettingsText Title="Histórico de Transferencias primarias" 
                    ...
                    <Columns>
                        ...
                        <dxwgv:GridViewDataDateColumn Caption="Fecha de Transferencia" 
                            FieldName="Fecha_Aplicacion" VisibleIndex="4">
                        </dxwgv:GridViewDataDateColumn>
                        ...
                        <dxwgv:GridViewDataComboBoxColumn Caption="Archivo de Concentración" 
                            FieldName="idArchivoDestino" VisibleIndex="3">
                            <PropertiesComboBox DataSourceID="dsArchivos" TextField="Archivo_Descripcion" 
                                ValueField="idArchivo" ValueType="System.Int32">
                            </PropertiesComboBox>
                        </dxwgv:GridViewDataComboBoxColumn>
                        ...
                        <dxwgv:GridViewDataTextColumn Caption="Detalle" VisibleIndex="7">
                            <DataItemTemplate>
    ...
    <asp:ObjectDataSource ID="dsTransferenciaActiva" runat="server" 
            SelectMethod="ListaTransferencias_Primarias" 
        TypeName="Portalv9.WSArchivo.Service1" 
        InsertMethod="ABC_Transferencias_Primarias" 
        UpdateMethod="ABC_Transferencias_Primarias">
        <UpdateParameters>

<%@ Page Language="vb" AutoEventWireup="false" AspCompat="true" CodeBehind="Wfrm_ReporteExpedientesReservados.aspx.vb"
    MasterPageFile="~/Masterpages/Adminmaster2col.master" Inherits="Portalv9.Wfrm_ReporteExpedientesReservados" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div>
        <table>
            <tr>
                ...
                <td>
                    <dx:ASPxDateEdit ID="DateEditFechaHasta" runat="server">
                    </dx:ASPxDateEdit>
                </td>
                <td>
    ...
    <div>
        <dxxr:ReportToolbar ID="ReportToolcgca" runat='server' ShowDefaultButtons='False'
            ReportViewer="<%# ReportExpedientesReservados %>">
            <Items>
        ...
        <dxxr:ReportViewer ID="ReportExpedientesReservados" runat="server" ReportName="Portalv9.RPT_ExpedientesReservados">
        </dxxr:ReportViewer>
    </div>
</asp:Content>

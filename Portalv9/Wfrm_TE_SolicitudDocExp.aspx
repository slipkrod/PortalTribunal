<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Masterpages/1.master" CodeBehind="Wfrm_TE_SolicitudDocExp.aspx.vb" Inherits="Portalv9.Wfrm_TE_SolicitudDocExp" %>
    ...
    <table align="center" style="width: 100%; border: 1px solid #A3C0E8">
        ...
        <tr>
            ...
            <center>
                ...
                <asp:Label ID="lblcont" runat="server" Text="Contenido del Expediente" 
                    ForeColor="#3F5DBC" style="text-align: right"></asp:Label>
                        </td>
                        <td>
                <asp:Label ID="lbldoc" runat="server" Text="Seleccione los Doc a Enviar" 
                    ...
                    <tr>
                        ...
                        <td>
                            <dxe:ASPxButton ID="btninc" runat="server" 
                                Text="Incorporar Documentos al Expediente">
                            </dxe:ASPxButton>
                            <br />
                            <dxe:ASPxButton ID="btnagre" runat="server" Text="Agregar un nuevo expediente">
                            </dxe:ASPxButton>
                <dxwtl:ASPxTreeList ID="ASPxTreeList2" runat="server" 
                    ...
                    ClientInstanceName="ASPxTreeList1" Visible="False">
                    <SettingsText CommandCancel="Cancelar" CommandDelete="Borrar" 
                        CommandEdit="Editar" CommandNew="Nuevo" CommandUpdate="Actualizar" 
                        ConfirmDelete="¿Seguro desea borrar este registro?" 
                        RecursiveDeleteError="Primero debe borrar los registros hijos." />

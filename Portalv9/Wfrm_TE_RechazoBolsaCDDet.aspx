<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Masterpages/1.master" CodeBehind="Wfrm_TE_RechazoBolsaCDDet.aspx.vb" Inherits="Portalv9.Wfrm_TE_RechazoBolsaCDDet" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div style="height: 450px">
            <TABLE id="Table1" style="Z-INDEX: 100; LEFT: 189px; WIDTH: 636px; POSITION: absolute; TOP: 7px;  margin-right: 0px;"
				borderColor="#eaeaea" align="left" border="1">
				<tr>
					<td style="HEIGHT: 7px; width: 466px;"><asp:label id="lblTitle" runat="server" 
                            Font-Italic="True" Font-Bold="True" Height="16px" Width="527px"
							Font-Names="Arial" Font-Size="10pt"> Envío->Centro de distribución/Rechazo de folio</asp:label></td>
				</tr>
				<tr>
					<td vAlign="top" style="width: 466px; height: 298px;">
						
							<TABLE id="Table2" style="width: 601px; height: 338px;" cellSpacing="0" 
                                cellPadding="0" border="0">
								<tr>
									<td style="HEIGHT: 23px; width: 584px;" vAlign="middle" align="right">Folio 
								...
								<tr>
									<td style="WIDTH: 584px" vAlign="top" align="right">Código&nbsp;del 
																				expediente:&nbsp;</td>
									<td vAlign="top" align="left" style="width: 222px"><asp:label id="lblLLave" 
                                            runat="server" Width="406px" Font-Names="Arial" Font-Size="10pt"></asp:label></td>
								</tr>
								<tr>
									<td style="WIDTH: 584px" vAlign="top" align="left">&nbsp;</td>
...
<SettingsText ConfirmDelete="&#191;Seguro desea borrar este registro?" CommandEdit="Editar" 
                        ...
                        RecursiveDeleteError="Primero debe borrar los registros hijos."></SettingsText>
...
<SettingsEditing EditFormColumnCount="1" Mode="EditFormAndDisplayNode"></SettingsEditing>
                    <Columns>
...
<EditFormSettings Visible="True"></EditFormSettings>
                        ...
                        <dxwtl:TreeListTextColumn Caption="Nivel" FieldName="Nivel" Name="Nivel" 
                            Visible="False" VisibleIndex="3">
								...
								<tr>
									<td style="text-align: right; width: 584px;"><asp:label id="Label3" runat="server">Descripción de la inconsistencia:</asp:label></td>
									<td>
								...
								<tr>
									<td style="text-align: right; width: 584px;">Observaciones:</td>
									<td>
								...
								<tr>
									<td style="WIDTH: 584px" vAlign="bottom" align="left"><B><FONT face="Arial, Helvetica, sans-serif" color="#000000" size="2"></FONT></B></td>
									<td vAlign="top" align="left" style="width: 222px">
								...
								<tr>
									<td style="WIDTH: 584px" vAlign="bottom" align="left">&nbsp;</td>
									<td vAlign="top" align="left" style="width: 222px">

<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/Masterpages/Adminmaster2col.master" CodeBehind="Wfrm_ReporteGS.aspx.vb" Inherits="Portalv9.Wfrm_ReporteGS" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <dxxr:ReportViewer ID="Reportgs" runat="server" 
            ReportName="Portalv9.RPT_GuiaSimple" 
            Report="<%# new Portalv9.RPT_GuiaSimple() %>">
    </dxxr:ReportViewer>
    </div>
    </asp:Content>

...
Partial Public Class Wfrm_TE_MCSolicitudDoc
    ...
    Private Function CreaQuery() As String
        ...
        srtSQL = "select Folio_bolsa,Llave_expediente,TrackinMultiva.dbo.fn_IndiceBusqueda(TrackinMultiva.dbo.corteinstancia.InstanciaID,Archivo_indices.idFolio) as Indice_de_busqueda, Archivo_indices.idfolio, InstanciaID, Archivo_indices.IDDescripcion,Archivo_indices.IdElemento as TipoExpediente, ISNULL(Solicita.Nombre, '') + ' ' + " & _
    ...
    Protected Sub ImageButton3_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles ImageButton3.Click
        Response.Redirect("Wfrm_TE_MCSolicitudDocExp.aspx?confidencial=" & Request.QueryString("confidencial"))

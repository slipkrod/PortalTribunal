<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Masterpages/Adminmaster2col.master" CodeBehind="Wfrm_Transferencia_Secundaria_Seleccionados_Cajas.aspx.vb" Inherits="Portalv9.Wfrm_Transferencia_Secundaria_Seleccionados_Cajas" %>
...
<dx:PopupControlContentControl ID="PopupControlContentControl1" runat="server">
    ...
    <asp:ObjectDataSource ID="dsTransferenciaActiva" runat="server" 
        ...
        <SelectParameters>
            ...
            <asp:Parameter Name="Baja" Type="Int32" />
        </SelectParameters>
    </asp:ObjectDataSource>
    <asp:ObjectDataSource ID="dsExpedientesTransferir" runat="server" 
            SelectMethod="Lista_Transferencias_Secundarias_Documentos" 
        TypeName="Portalv9.WSArchivo.Service1" 
        OldValuesParameterFormatString="original_{0}">
        <SelectParameters>
            <asp:QueryStringParameter Name="idFolio" QueryStringField="idFolio" 
    ...
    <asp:ObjectDataSource ID="dsCajas" runat="server" 
            SelectMethod="Lista_Transferencias_Secundarias_Cajas" 
        TypeName="Portalv9.WSArchivo.Service1" 
        DeleteMethod="ABC_Transferencias_Secundarias_Cajas" 
        InsertMethod="ABC_Transferencias_Secundarias_Cajas" 
        UpdateMethod="ABC_Transferencias_Secundarias_Cajas">
        <DeleteParameters>
            ...
            <asp:Parameter Name="idFolioCaja" Type="Int32" DefaultValue="" />

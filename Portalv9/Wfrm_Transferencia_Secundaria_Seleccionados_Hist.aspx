<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Masterpages/Adminmaster2col.master" CodeBehind="Wfrm_Transferencia_Secundaria_Seleccionados_Hist.aspx.vb" Inherits="Portalv9.Wfrm_Transferencia_Secundaria_Seleccionados_Hist" %>
    ...
    <PanelCollection>
        <dxp:PanelContent ID="PanelContent1" runat="server">
            <table style="width:100%">
                ...
                <tr>
                    <td>
                        <asp:label id="Label3" runat="server" Font-Names="Arial" Font-Bold="True" 
                            Text="Archivo de Concentración: "></asp:label>
                    </td>                        
                    <td>
                ...
                <tr>
                    <td>
                        <asp:label id="Label5" runat="server" Font-Names="Arial" Font-Bold="True" 
                            Text="Archivo Histórico: "></asp:label>
                    </td>                        
                    <td>
...
<br />
        ...
        <tr>
            <td style="width: 737px" colspan="2">
                <dxwgv:ASPxGridView ID="gdbuscadorresultado" runat="server" ClientInstanceName="grid" 
                    AutoGenerateColumns="False" DataSourceID="ObjectDataSource1" Width="980px" 
        ...
        <tr  >
            <td colspan="2">
                <dxwgv:ASPxGridView ID="gdbuscadorEliminar" runat="server" ClientInstanceName="grid" 
                    AutoGenerateColumns="False" DataSourceID="dsExpedientesEliminar" Width="980px" 
                    KeyFieldName="idFolioDetalle" EnableCallBacks="False">
                    <SettingsBehavior ProcessFocusedRowChangedOnServer="true" />
                    <SettingsText Title="Documentos a dar de Baja" />
                    <Columns>
                        <dxwgv:GridViewDataTextColumn Caption="idArchivo" FieldName="idArchivo" Visible="False" VisibleIndex="1">
                        </dxwgv:GridViewDataTextColumn>
                        <dxwgv:GridViewDataTextColumn FieldName="idFolioDetalle" Visible="False" 
    ...
    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" 
            SelectMethod="ListaVencimientos_Archivo_Concentracion_Seleccionados" 

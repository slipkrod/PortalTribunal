Public Partial Class Wfm_Captura_Documento_Nuevo_Indices
    ...
    Protected Sub aspxguardar_Click(ByVal sender As Object, ByVal e As EventArgs) Handles aspxguardar.Click
        ...
        Try
            ...
            For intI = 0 To dsNomraCampos.Tables(0).Rows.Count - 1
                ...
                End If
            Next
            NewURL = "Wfm_Captura_Expediente_Documentos.aspx?idArchivo=" & Request.QueryString("idArchivo") & "&idDescripcion=" & Request.QueryString("idDescripcion") & "&idSerie=" & Request.QueryString("idSeriePadre") & "&idNorma=" & Request.QueryString("idNorma")

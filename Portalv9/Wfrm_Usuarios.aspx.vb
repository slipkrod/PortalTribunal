        ...
        Try
            ...
            If dt.Rows.Count > 0 Then
                ...
                For i = 0 To intFin - 1
                    ...
                    MiText = Me.Form.FindControl("ContentPlaceHolder1").FindControl("txtDynamicUsr" & nDynamicUsrIdentidad)
                    strDato = MiText.Text
                    MiText = Nothing
                ...
                Try
                    ...
                    If dt.Rows.Count > 0 Then
                        ...
                        For i = 0 To dt.Rows.Count - 1
                            ...
                            End If
                            MiText = Me.Form.FindControl("ContentPlaceHolder1").FindControl("txtDynamicUsr" & dt.Rows(i).Item("DynamicUsrID"))

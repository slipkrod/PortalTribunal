<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Masterpages/1.master" CodeBehind="Wfrm_EN_RequerimientoDoc.aspx.vb" Inherits="Portalv9.Wfrm_EN_RequerimientoDoc" %>
...
<br />
     <dxwgv:ASPxGridView ID="ASPxGridView1" runat="server" Visible="False" 
         ...
         Font-Size="X-Small" KeyFieldName="IDDescripcion">
         <Columns>
             <dxwgv:GridViewDataHyperLinkColumn VisibleIndex="0">
                 <DataItemTemplate>
                     <dxe:ASPxButton ID="btnSolicitar" runat="server" CommandName="Solicitar" ToolTip="Ver Contenido del Expediente" 
                         Text="Ver" Width="58px" CommandArgument='<%# Bind("IDDescripcion") %>'>
                     </dxe:ASPxButton>
                 </DataItemTemplate>
             ...
             <dxwgv:GridViewDataTextColumn Caption="Valor" FieldName="valor" 
                 VisibleIndex="2" ToolTip="Valor Encontrado">
             </dxwgv:GridViewDataTextColumn>

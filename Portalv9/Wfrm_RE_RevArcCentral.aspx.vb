...
Partial Public Class Wfrm_RE_RevArcCentral
    Inherits System.Web.UI.Page
    Private Const estado As Integer = 86
    Private Const eventoError As Integer = 91
    Private Const eventoOK As Integer = 97

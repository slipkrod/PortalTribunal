<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Masterpages/1.master" CodeBehind="Wfrm_TE_MCCierraBolsa.aspx.vb" Inherits="Portalv9.Wfrm_TE_MCCierraBolsa" %>
...
<div id="pagetitle">
<asp:Label ID="lbltitulo" runat="server" Text="Envío --&gt; Usuario/Alta de Bolsas"> </asp:Label>
</div>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <dxwgv:ASPxGridView ID="ASPxGridView1" runat="server" 
        ...
        Visible="False" KeyFieldName="InstanciaID">
         <Columns>
    ...
    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" 
        ...
        <SelectParameters>
            <asp:Parameter DefaultValue="21" Name="EstadoID" Type="Int32" />
        </SelectParameters>
    </asp:ObjectDataSource>
    <asp:Button ID="btncerrar" runat="server" Text="Cerrar Bolsa" Visible="False" />
    <br />

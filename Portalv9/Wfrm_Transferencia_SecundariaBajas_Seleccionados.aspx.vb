...
Partial Public Class Wfrm_Transferencia_SecundariaBajas_Seleccionados
...
#End Region
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not Page.IsPostBack Then
            ...
            rsDatosTransferencia = sv.ListaBaja_Concentracion(Request.QueryString("idFolio"))
    ...
    Protected Sub butAceptar_Click(ByVal sender As Object, ByVal e As EventArgs) Handles butAceptar.Click
        ...
        sv.ABC_Transferencias_Secundarias_Bajas(3, Request.QueryString("idFolio"), 0, Now.Date, 0, "", 2)
        Response.Redirect("Wfrm_Transferencia_SecundariaBajas_Seleccionados_OK.aspx")
    End Sub


    Protected Sub butCambiar_Click(ByVal sender As Object, ByVal e As EventArgs) Handles butCambiar.Click
        Response.Redirect("Wfrm_Transferencia_SecundariaBajas_Seleccionados_Upd.aspx?idArchivo=" & Request.QueryString("idArchivo") & _

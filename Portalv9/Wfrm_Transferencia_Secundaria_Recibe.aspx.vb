...
Partial Public Class Wfrm_Transferencia_Secundaria_Recibe
...
#End Region
    ...
    Protected Sub btnBuscaTransferencia_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnBuscaTransferencia.Click
        ...
        rsDatosTransferencia = sv.ListaTransferencia_Secundaria(txtTransferencia.Value)
    ...
    Protected Sub butTransferir_Click(ByVal sender As Object, ByVal e As EventArgs) Handles butTransferir.Click
            ...
            Do While Not iterator.Current Is Nothing
                If iterator.Current.Selected Then
                    If iterator.Current.Level = 1 Then
                        sv.ABC_Transferencias_Secundarias_Expedientes(3, txtTransferencia.Value, iterator.Current.GetValue("idFolioDetalle"), iterator.Current.GetValue("idDescripcion"), iterator.Current.GetValue("idDocumentoPID"), 3)
                    ElseIf iterator.Current.Level = 2 Then
                        sv.ABC_Transferencias_Secundarias_Documentos(3, txtTransferencia.Value, iterator.Current.GetValue("idFolioDetalle"), iterator.Current.GetValue("idFolioDetalleDocumento"), iterator.Current.GetValue("idDescripcion"), iterator.Current.GetValue("idDocumentoPID"), 3)
                    End If
                Else
        ...
        sv.ABC_Transferencias_Secundarias(3, txtTransferencia.Value, 0, Now.Date, 0, 0, "", 3)

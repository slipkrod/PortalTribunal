<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Masterpages/1.master" CodeBehind="Wfrm_EN_RevUsuarioContenido.aspx.vb" Inherits="Portalv9.Wfrm_EN_RevUsuarioContenido" %>
        ...
        <tr>
            ...
            <td >
                <asp:ImageButton ID="btnAceptar" runat="server" BorderWidth="0" 
                    ...
                    ImageUrl="~/Images/env_entrega_usu.gif" Width="109px" />
                &nbsp;&nbsp;

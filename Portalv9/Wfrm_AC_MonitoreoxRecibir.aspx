<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Masterpages/1.master" CodeBehind="Wfrm_AC_MonitoreoxRecibir.aspx.vb" Inherits="Portalv9.Wfrm_AC_MonitoreoxRecibir" %>
...
<div id="pagetitle">
<asp:Label ID="Label1" runat="server" Text="Monitoreo folios por recibir"> </asp:Label>
</div>
</asp:Content>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <SettingsText Title="Envío --&gt Archivo central/Monitoreo folios por recibir" />
        <Columns>
    ...
    <SettingsText Title="Recolección --&gt Archivo central/Monitoreo folios por recibir" />
    <Columns>
            <dxwgv:GridViewDataTextColumn Caption="Mensajería" FieldName="Mensajeria" 
                VisibleIndex="0">
            </dxwgv:GridViewDataTextColumn>

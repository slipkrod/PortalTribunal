...
#End Region
        ...
        Select Case e.CommandArgs.CommandName
            Case "btnVer"
                If gdTransferenciaActiva.GetRowValuesByKeyValue(e.KeyValue, "Status") = 0 Then                    
                    Response.Redirect("Wfrm_ValorizacionArchivos.aspx?idArchivo=" & gdTransferenciaActiva.GetRowValuesByKeyValue(e.KeyValue, "idArchivoOrigen") & "&idFolio=" & gdTransferenciaActiva.GetRowValuesByKeyValue(e.KeyValue, "idFolio"))
                ElseIf gdTransferenciaActiva.GetRowValuesByKeyValue(e.KeyValue, "Status") = 1 Then
                    Response.Redirect("Wfrm_ValorizacionSeleccionados.aspx?idArchivo=" & gdTransferenciaActiva.GetRowValuesByKeyValue(e.KeyValue, "idArchivoOrigen") & _
    ...
    Protected Sub gdTransferencaHist_RowCommand(ByVal sender As Object, ByVal e As DevExpress.Web.ASPxGridView.ASPxGridViewRowCommandEventArgs) Handles gdTransferencaHist.RowCommand
        Select Case e.CommandArgs.CommandName
            Case "btnVer"
                Response.Redirect("Wfrm_ValorizacionSeleccionados_Hist.aspx?idArchivo=" & gdTransferencaHist.GetRowValuesByKeyValue(e.KeyValue, "idArchivoOrigen") & _
              "&idNorma=" & lblidNorma.Text & _

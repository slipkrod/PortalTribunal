...
#End Region
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not Page.IsPostBack Then
            lblTitle.Text = "Reporte de Usuarios por Perfil"
            lblTitle2.Text = "Reporte de Usuarios por Perfil"
...
#End Region
    ...
    Private Sub CargaGrid(ByRef ptTicket As IDTicket, ByRef prRespuesta As Respuesta)
        ...
        Dim ds As DataSet = sv.RptAdminUsrXPerfil(ptTicket, prRespuesta, Me.ddlPerfiles.SelectedValue)
        ...
        If prRespuesta.RespuestaID = Application("GSTR_RESPUESTA_OK_DEFAULT") Then
            ...
            If ds.Tables(0).Rows.Count > 0 Then
                ...
                For i = 0 To ds.Tables(0).Rows.Count - 1
                    strPerfilAct = ds.Tables(0).Rows(i).Item("PerfilUsuarioID")
                    If strPerfilAct <> strPerfilAnt Then
                        MiDr = MiDt.NewRow()
                        MiDr("NominaEsp") = ds.Tables(0).Rows(i).Item("NombrePerfil")
                        MiDr("NombreUsr") = ""
                        MiDr("UsrID") = ""
                        MiDr("GEID") = ""
                        MiDr("SOEID") = ""
                        ...
                        'Encabezados
                        MiDr = MiDt.NewRow()
                        MiDr("NominaEsp") = "Nomina Especial"
                        MiDr("NombreUsr") = "Usuario"
                        MiDr("UsrID") = "Login"
                        MiDr("GEID") = "GEID"
                        MiDr("SOEID") = "SOEID"
                        MiDr("RITSID") = "RITSID"
                    ...
                    MiDr("NombreUsr") = ds.Tables(0).Rows(i).Item("NombreUsr")
                    ...
                    strPerfilAnt = ds.Tables(0).Rows(i).Item("PerfilUsuarioID")
                Next
    ...
    Protected Sub btnExportar2_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnExportar2.Click
        ...
        Response.AddHeader("Content-Disposition", "attachment;filename=RepUsrXPerfil.doc")
    ...
    Protected Sub btnExportar_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnExportar.Click
        ...
        Response.AddHeader("Content-Disposition", "attachment;filename=RepUsrXPerfil.xls")
        Response.Charset = "UTF-8"
        Response.ContentEncoding = Encoding.Default
        Response.Write(sb.ToString())
        Response.End()

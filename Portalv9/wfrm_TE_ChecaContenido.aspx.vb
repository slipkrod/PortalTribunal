...
Partial Public Class wfrm_TE_ChecaContenido
    Inherits System.Web.UI.Page

    Private Const estado As Integer = 10
    Private eventoOK As Integer = 14     '-- A Apertura de Expediente
    Private Const eventoFaltantes As Integer = 15
            ...
            If CType(lblDocumentos.Text, Integer) = ASPxTreeList1.GetSelectedNodes.Count Then
                ...
                If IsValid Then
                    ...
                    If svr.ObtenTipoTraslado(lblInstancia.Text, Request.QueryString("FolioBolsa")) > 0 Then
                        eventoOK = 14  '-- A Apertura de Expediente
                        GuardaDocumentos_Arbol(lblInstancia.Text, eventoOK)
                        GuardaDocumentos_Hijos(eventoOK)
                    Else
                        eventoOK = 12  '-- A Integracion de Documentos
                        GuardaDocumentos_Hijos(eventoOK)

                    End If
                    Response.Redirect("Wfrm_TE_RevArcCentral.aspx?FolioBolsa=" & Request.QueryString("FolioBolsa"))
                End If
            Else
                dlgBoxExcepciones.ShowMessage("Para poder enviarlo a apertura de expediente es necesario que todos los documentos esten seleccionados")
            End If
        Catch ex As Exception
            ...
            Else
                ...
                If svr.ObtenTipoTraslado(lblInstancia.Text, Request.QueryString("FolioBolsa")) > 0 Then
                    ...
                    Else
                        ...
                        Me.dlgBoxExcepciones.ShowConfirmation("Se ha enviado aviso por correo electrónico", "Aviso", True, True)

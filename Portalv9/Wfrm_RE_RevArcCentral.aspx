<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Masterpages/1.master" CodeBehind="Wfrm_RE_RevArcCentral.aspx.vb" Inherits="Portalv9.Wfrm_RE_RevArcCentral" %>
                        ...
                        <dxwgv:GridViewDataTextColumn VisibleIndex="0">
                            ...
                            <DataItemTemplate>
                                <dxe:ASPxHyperLink ID="ASPxHyperLink1" runat="server" 
                                     NavigateUrl='<%# "wfrm_TE_ChecaContenido.aspx?FolioBolsa=" &  Eval("Folio_bolsa").toString & "&InstanciaPID=" & Eval("InstanciaPID").toString %>'  Text="Recibir" />
                            </DataItemTemplate>

<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Masterpages/1.master" CodeBehind="Wfrm_TE_AltaDocumentos.aspx.vb" Inherits="Portalv9.Wfrm_TE_AltaDocumentos" %>
             ...
             <dxwgv:GridViewDataHyperLinkColumn VisibleIndex="0">
                 <DataItemTemplate>
                     <dxe:ASPxHyperLink ID="ASPxHyperLink1" runat="server" 
                         NavigateUrl='<%# "Wfrm_TE_SolicitudDocExp.aspx?IdDescripcion=" &  Eval("IdDescripcion") & "&confidencial=" & Request.QueryString("confidencial") & "&InstanciaPID=" & Eval("InstanciaId")  %>' Text="Ver" />
                 </DataItemTemplate>

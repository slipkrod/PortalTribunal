<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Masterpages/1.master" CodeBehind="Wfrm_TE_SolicitudExp.aspx.vb" Inherits="Portalv9.Wfrm_TE_SolicitudExp" %>
    ...
    <table align="center" style="width: 100%; border: 1px solid #A3C0E8">
            ...
            <td style="height: 21px; text-align: left;">
                <dxe:ASPxComboBox ID="cmbTipoExpediente" runat="server" 
                    ...
                    <Columns>
                        ...
                        <dxe:ListBoxColumn Caption="Metodo_Destruccion" FieldName="Metodo_Destruccion" 
                            Visible="False" />
        ...
        <tr>
            <td style="height: 21px; width: 193px">
                &nbsp;</td>
            <td style="height: 21px; text-align: left;">
                    <dxe:ASPxButton ID="ASPxButton2" runat="server" Text="Continuar" Visible="False" CausesValidation="False">
                    </dxe:ASPxButton>
        ...
        <tr>
            ...
            <center>
                <dxwgv:ASPxGridView ID="ASPxGridView1" runat="server" 
                    ...
                    <Columns>
                        <dxwgv:GridViewDataTextColumn Caption="CampoID" FieldName="CampoID" Visible="False" VisibleIndex="0">
                        ...
                        <dxwgv:GridViewDataTextColumn Caption="Documento Origen" FieldName="Serie_nombre" VisibleIndex="0">
                            <PropertiesTextEdit>
                                <Style Font-Size="XX-Small" ForeColor="#000066"></Style>
                            </PropertiesTextEdit>
                            <CellStyle Font-Size="Smaller" ForeColor="#3F5DBC" HorizontalAlign="Left"></CellStyle>
                        </dxwgv:GridViewDataTextColumn>
                        <dxwgv:GridViewDataTextColumn Caption="Nombre del campo" FieldName="Indice_descripcion" VisibleIndex="1">
                            <PropertiesTextEdit ClientInstanceName="Indice_descripcion"></PropertiesTextEdit>
                            <DataItemTemplate>
                        ...
                        <dxwgv:GridViewDataTextColumn Caption="Indice_LongitudMax" FieldName="Indice_LongitudMax" VisibleIndex="1" Visible="False">
                        </dxwgv:GridViewDataTextColumn>
                        <dxwgv:GridViewDataTextColumn Caption="Indice_Obligatorio" FieldName="Indice_Obligatorio" VisibleIndex="2" Visible="False">
                        </dxwgv:GridViewDataTextColumn>
                        <dxwgv:GridViewDataTextColumn Caption="Indice_Unico" FieldName="Indice_Unico" VisibleIndex="3" Visible="False">
                        </dxwgv:GridViewDataTextColumn>
                        <dxwgv:GridViewDataTextColumn Caption="Indice_Mascara" FieldName="Indice_Mascara" VisibleIndex="4" Visible="False">
                        </dxwgv:GridViewDataTextColumn>
                        <dxwgv:GridViewDataTextColumn Caption="idSerie" FieldName="idSerie" Visible="False" VisibleIndex="2">
                        </dxwgv:GridViewDataTextColumn>
                        <dxwgv:GridViewDataTextColumn Caption="idNorma" FieldName="idNorma" Visible="False" VisibleIndex="2">
                        </dxwgv:GridViewDataTextColumn>
                        <dxwgv:GridViewDataTextColumn Caption="idArea" FieldName="idArea" Visible="False" VisibleIndex="2">
                        </dxwgv:GridViewDataTextColumn>
                        <dxwgv:GridViewDataTextColumn Caption="idElemento" FieldName="idElemento" Visible="False" VisibleIndex="2">
                        </dxwgv:GridViewDataTextColumn>
                        <dxwgv:GridViewDataTextColumn Caption="idNivel" FieldName="idNivel" Visible="False" VisibleIndex="2">
                        </dxwgv:GridViewDataTextColumn>
                    </Columns>
                </dxwgv:ASPxGridView>
            </center>
        ...
        <tr>
            <td style="height: 21px; " colspan="2">
            <center>
                <dxe:ASPxButton ID="btnSalvar" runat="server" AutoPostBack="False" CausesValidation="False" Text="Salvar" Visible="False">
                </dxe:ASPxButton>
            </center>
            </td>
        </tr>

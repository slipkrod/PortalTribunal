<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Masterpages/Adminmaster2col.master" CodeBehind="Wfrm_Transferencia_SecundariaBajas_Seleccionados_Hist.aspx.vb" Inherits="Portalv9.Wfrm_Transferencia_SecundariaBajas_Seleccionados_Hist" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="TituloBarra" runat="server">
    <div id="pagetitle">
        <asp:Label ID="lbltitulo" runat="server" Text="Baja Documental"></asp:Label>
    </div>
</asp:Content>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <br />
    <dxrp:ASPxRoundPanel ID="rpHeader" Width="100%" HeaderText="Datos de la baja" 
      runat="server">
    <PanelCollection>

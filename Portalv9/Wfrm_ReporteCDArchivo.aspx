<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Masterpages/Adminmasteranidada.master" CodeBehind="Wfrm_ReporteCDArchivo.aspx.vb" Inherits="Portalv9.Wfrm_ReporteCDArchivo" %>
                        ...
                        <Columns>
                             <dxwtl:TreeListTextColumn Caption="Imprimir" FieldName="idArchivo" 
                                 ...
                                 <DataCellTemplate>
                                     ...
                                     <dxe:ASPxHyperLink ID="ASPxHyperLink1" runat="server"     ImageUrl="~/Images/btn_imprimir.gif" NavigateUrl='<%# "Wfrm_ReporteCD.aspx?idArchivo=" &  Eval("idArchivo").toString  & "&idNorma=" & Eval("idNorma").toString %>'
                                         Text="Ver Detalle" />
                                 </DataCellTemplate>

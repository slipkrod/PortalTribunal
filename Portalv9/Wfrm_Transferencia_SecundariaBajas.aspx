<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Masterpages/Adminmaster2col.master" CodeBehind="Wfrm_Transferencia_SecundariaBajas.aspx.vb" Inherits="Portalv9.Wfrm_Transferencia_SecundariaBajas" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div>
    <asp:label id="lblTitle" runat="server" Font-Size="Small" Height="16px" Font-Names="Arial" Font-Bold="True" Font-Italic="True">Expurgos documentales</asp:label>
</div>
<br />
        ...
        <tr>
            <td>
                <dxwgv:ASPxGridView ID="gdTransferenciaActiva" runat="server" ClientInstanceName="grid" 
                    ...
                    <SettingsText Title="Expurgos documentales" CommandEdit="Editar" 
        ...
        <tr>
            <td valign="top">
                <dxwgv:ASPxGridView ID="gdTransferencaHist" runat="server" ClientInstanceName="grid" 
                    ...
                    KeyFieldName="idFolio" EnableCallBacks="False">
                    <SettingsBehavior ProcessFocusedRowChangedOnServer="true" />
                    <SettingsText Title="Histórico de expurgos documentales" 
    ...
    <asp:ObjectDataSource ID="dsTransferenciaActiva" runat="server" 
            SelectMethod="ListaBajas_Concentracion" 
        TypeName="Portalv9.WSArchivo.Service1" 
        InsertMethod="ABC_Transferencias_Secundarias_Bajas" 
        UpdateMethod="ABC_Transferencias_Secundarias_Bajas" 
        DeleteMethod="ABC_Transferencias_Secundarias_Bajas">
        <DeleteParameters>

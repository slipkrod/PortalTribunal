<%@ Page Language="vb" AutoEventWireup="false" AspCompat="true" CodeBehind="Wfrm_ReporteInventarioGeneral.aspx.vb" MasterPageFile="~/Masterpages/Adminmaster2col.master" Inherits="Portalv9.Wfrm_ReporteInventarioGeneral" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <dxxr:ReportViewer ID="ReportInventario" runat="server" 
            ReportName="Portalv9.RPT_InventarioGeneral">
    </dxxr:ReportViewer>

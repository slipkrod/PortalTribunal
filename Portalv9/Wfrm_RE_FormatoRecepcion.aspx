<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Masterpages/1.master" CodeBehind="Wfrm_RE_FormatoRecepcion.aspx.vb" Inherits="Portalv9.Wfrm_RE_FormatoRecepcion" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <table id="Table1" align="left" border="1" bordercolor="#eaeaea" 
        style="WIDTH: 600px; HEIGHT: 256px" width="600">
        <tr>
            <td colspan="2" style="WIDTH: 1114px; HEIGHT: 21px" width="1114">
                <asp:Label ID="lblTitle" runat="server" Font-Bold="True" Font-Italic="True" 
                    Font-Names="Arial" Font-Size="10pt" Height="5px" Width="544px"> Recolección-&gt;Oficinas/Recepción de folios</asp:Label>
            </td>
        </tr>
        <tr>
            <td align="left" 

<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Masterpages/1.master" CodeBehind="Wfrm_TE_RecepMC.aspx.vb" Inherits="Portalv9.Wfrm_TE_RecepMC" %>

<asp:Content ID="Content1" ContentPlaceHolderID="TituloBarra" runat="server">
<div id="pagetitle">
<asp:Label ID="lbltitulo" runat="server" Text="Envío --&gt Mesa de Control/Recepción de folios"> </asp:Label>
</div>
</asp:Content>
        ...
        <tr>
            ...
            <td style="height: 21px; text-align: center;">
                <asp:ImageButton ID="ibtnrecibir" runat="server" 
                    ImageUrl="Images/Recibir_Bolsa.gif" Height="54px" />
            </td>
        </tr>
    </table>

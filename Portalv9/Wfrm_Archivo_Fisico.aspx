<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Masterpages/1.master" CodeBehind="Wfrm_Archivo_Fisico.aspx.vb" Inherits="Portalv9.Wfrm_Archivo_Fisico" %>
...
<asp:label id="lblTitle" runat="server" Font-Size="Small" Width="232px" Height="16px" Font-Names="Arial" Font-Bold="True" Font-Italic="True">Archivo Físico</asp:label>
            ...
            Width="630px" KeyFieldName="idArchivo_Fisico">
             <SettingsBehavior ConfirmDelete="true" />
              <SettingsText ConfirmDelete="¿ Estás seguro de querer eliminar éste elemento ?" />
                     <Columns>
                         <dxwgv:GridViewDataTextColumn Caption="idArchivo_Fisico" FieldName="idArchivo_Fisico" 
                             Name="idArchivo_Fisico" ReadOnly="True" Visible="False" VisibleIndex="0">
                         </dxwgv:GridViewDataTextColumn>
                         <dxwgv:GridViewDataTextColumn Caption="Nombre del archivo físico" 
                             FieldName="Archivo_Fisico_Descripcion" Name="Archivo_Fisico_Descripcion" 
                             VisibleIndex="0">
                         </dxwgv:GridViewDataTextColumn>
                         <dxwgv:GridViewDataHyperLinkColumn Caption="Ubicaciones" FieldName="idArchivo_Fisico" 
                             ReadOnly="True" ShowInCustomizationForm="False" VisibleIndex="1" 
                             Width="40px">
                             <PropertiesHyperLinkEdit ImageUrl="images/caja.gif" 
                                 
                                 NavigateUrlFormatString="Wfrm_Archivo_Fisico_Detalle.aspx?idArchivo_Fisico={0}" 
                                 Text="Elementos">
                 ...
                 <dxwgv:GridViewCommandColumn Caption="Eliminar" VisibleIndex="5" Width="50px"> <DeleteButton Text="Eliminar" Visible="true"></DeleteButton></dxwgv:GridViewCommandColumn>                         
                       <%--  
    ...
    <asp:ObjectDataSource ID="dsArchivoFisico" runat="server" 
        SelectMethod="Lista_Archivo_Fisico" 
        TypeName="Portalv9.WSArchivo.Service1" 
        UpdateMethod="ABC_Archivo_Fisico" 
        DeleteMethod="ABC_Archivo_Fisico" 
        InsertMethod="ABC_Archivo_Fisico">
        <DeleteParameters>
            <asp:Parameter Name="op" Type="Object" defaultvalue="1" />
            <asp:Parameter Name="idArchivo_Fisico" Type="Int32"/>
            <asp:Parameter Name="Archivo_Fisico_Descripcion" Type="String" />
        </DeleteParameters>
        <UpdateParameters>

<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Masterpages/1.master" CodeBehind="Wfrm_TE_MCBolsasSelladas.aspx.vb" Inherits="Portalv9.Wfrm_TE_MCBolsasSelladas" %>
...
<div id="pagetitle">
<asp:Label ID="Label1" runat="server" Text="Monitoreo de Bolsas Selladas"> </asp:Label>
</div>
</asp:Content>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <dxwgv:ASPxGridView ID="ASPxGridView1" runat="server" 
     ...
     <SettingsText Title="Envío --&gt; Mesa de control --&gt; Monitoreo de bolsas selladas" />
        <Columns>

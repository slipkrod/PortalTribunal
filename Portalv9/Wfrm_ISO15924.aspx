<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/Masterpages/Adminmasteranidada.master" CodeBehind="Wfrm_ISO15924.aspx.vb" Inherits="Portalv9.Wfrm_ISO15924" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder4" Runat="Server">
    ...
    <div>
         <dxwgv:ASPxGridView ID="aspxgdiso15924" runat="server" KeyFieldName="idFolio" 
             OnRowUpdating="aspxgdiso15924_RowUpdating" 
             OnRowInserting="aspxgdiso15924_RowInserting" 
             OnRowDeleting="aspxgdiso15924_RowDeleting" 
             OnPageIndexChanged="aspxgdiso15924_PageIndexChanged" 
       ...
       <Columns>
                   <dxwgv:GridViewDataTextColumn  Caption="ID"  FieldName="idFolio" ReadOnly="True" VisibleIndex="0">
                    ...
                    <PropertiesTextEdit> <ClientSideEvents KeyPress="function numeros(){var key=window.event.keyCode;if (key < 48 || key > 57){window.event.keyCode=0;}}"/>
                    </PropertiesTextEdit>
                  </dxwgv:GridViewDataTextColumn>
                  <dxwgv:GridViewDataTextColumn Caption="Clave Alfa" FieldName="Clave" ReadOnly="false" VisibleIndex="2">
                  </dxwgv:GridViewDataTextColumn>

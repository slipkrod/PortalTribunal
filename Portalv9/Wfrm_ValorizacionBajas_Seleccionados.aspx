<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Masterpages/Adminmaster2col.master" CodeBehind="Wfrm_ValorizacionBajas_Seleccionados.aspx.vb" Inherits="Portalv9.Wfrm_ValorizacionBajas_Seleccionados" %>
...
<br />
    <table style="width:100%;" id="tableMain" runat="server" >
        ...
        <tr>
            ...
            <td valign="top">
                <dxe:ASPxButton ID="butAceptar" runat="server" Text="Dar de baja" 
                    Width="160px">
                </dxe:ASPxButton>
            </td>
        </tr>
    ...
    <asp:ObjectDataSource ID="dsExpedientesEliminar" runat="server" 
            SelectMethod="ListaBajas_Archivo_Tramite_Seleccionados" 

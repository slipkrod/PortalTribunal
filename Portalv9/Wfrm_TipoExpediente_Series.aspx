<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Masterpages/1.master" CodeBehind="Wfrm_TipoExpediente_Series.aspx.vb" Inherits="Portalv9.Wfrm_TipoExpediente_Series" %>
    ...
    <table style="width: 100%">
        <tr>
    	    ...
    	    <dxe:ASPxHyperLink ID="Regresar" runat="server" 
                ImageUrl="~/Images/regresar.gif" NavigateUrl='<%# "~/Wfrm_TipoExpediente.aspx?idArchivo=" & ConfigurationManager.AppSettings("Archivo") & "&idNorma=" & Request.QueryString("idNorma") & "&idNivel=" & Request.QueryString("idNivel") %>' />
                ...
                <dxwtl:ASPxTreeList ID="ASPxTreeList1" runat="server" 
                    ...
                    <Columns>
                        ...
                        <dxwtl:TreeListComboBoxColumn Caption="Tipo de elemento" FieldName="idNivel" 
                            ...
                            <PropertiesComboBox ValueType="System.Int32" DataSourceID="dsNiveles" 
                        ...
                        <dxwtl:TreeListTextColumn Caption="Indices" VisibleIndex="4">
                            ...
                            <EditFormSettings Visible="False" />
                            <DataCellTemplate>
                                <dxe:ASPxHyperLink ID="ASPxHyperLink2" runat="server" Text="Detalle" NavigateUrl='<%# "Wfrm_TipoExpediente_Indices.aspx?idArchivo=" & ConfigurationManager.AppSettings("Archivo") & "&idNorma=" & Eval("idNorma").ToString  & "&idNivelP=" & Request.QueryString("idNivel").ToString  & "&idNivel=" & Eval("idNivel").ToString  & "&idSerie=" & Eval("idSerie").ToString & "&idSerieP=" & Request.QueryString("idSerie").ToString & "&TipoExp=1" %>'/>
                            </DataCellTemplate>
                        </dxwtl:TreeListTextColumn>
                        <dxwtl:TreeListTextColumn Caption="Imagen_close" FieldName="Imagen_close" 
                            Name="Imagen_close" Visible="False" VisibleIndex="5">
                        </dxwtl:TreeListTextColumn>
                        <dxwtl:TreeListTextColumn Caption="PermisoID" FieldName="PermisoID" 
                            Name="PermisoID" Visible="False" VisibleIndex="5">
                        </dxwtl:TreeListTextColumn>
                    </Columns>
                </dxwtl:ASPxTreeList>
            ...
            <td>
                ...
                <asp:ObjectDataSource ID="dsLista_SeriesModelo_Hijos" runat="server" 
                    ...
                    <DeleteParameters>
                        ...
                        <asp:Parameter Name="idSeriePID" Type="Int32" DefaultValue="" />
                ...
                <asp:ObjectDataSource ID="dsNiveles" runat="server" 
                    SelectMethod="ListaNorma_Nivel_SerieyDocumento" 

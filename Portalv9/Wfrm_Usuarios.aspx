<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Wfrm_Usuarios.aspx.vb" Inherits="Portalv9.Wfrm_Usuarios" MasterPageFile="~/Masterpages/Adminmasteranidada.Master" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder4" Runat="Server">
    ...
    <asp:Panel ID="Panel1" runat="server" Height="786px" Width="765px"> 
        <table style="LEFT: 2px; TOP: 2px; width: 91%; height: 936px;" cellSpacing="0" cellPadding="0" 
            border="0">
				<tr>
					<td vAlign="top" class="style2"></td>
					<td vAlign="top" align="left" width="*">
						<table cellSpacing="0" cellPadding="0" width="100%" border="0" 
                            style="margin-left: 0px; height: 41px;">
							<tr>
								<td class="style1" colspan="3">
                                    <br />
                                    <asp:label id="lblTitle" runat="server" Font-Size="Small" Width="232px" Height="30px" Font-Names="Arial"
										Font-Bold="True" Font-Italic="True"> Texto en el page_ load</asp:label>
                                    <br />
                                </td>
							</tr>
							<tr>
						...
						<asp:datagrid id="grdUser" runat="server" Width="605px" Height="18px" 
                            HorizontalAlign="Justify" AllowPaging="True" AutoGenerateColumns="False"
							AllowSorting="True" DataKeyField="UsrID" style="margin-bottom: 0px" CellPadding="4" 
							...
							<Columns>
								<asp:ButtonColumn  Text="Editar" DataTextField="ApellidoP" SortExpression="ApellidoP" HeaderText="Apellido P"
								...
								<asp:BoundColumn DataField="ApellidoM" SortExpression="ApellidoM" HeaderText="Apellido M"></asp:BoundColumn>
								...
								<asp:ButtonColumn Text="Editar" DataTextField="UsrID" SortExpression="Usrid" HeaderText="Login" CommandName="Editar"></asp:ButtonColumn>
						...
						<asp:panel id="pnlFormUser" Font-Size="XX-Small" Width="605px" Height="360px" Font-Names="Arial Narrow"
							Runat="server" BorderWidth="1px" BorderStyle="Solid" ForeColor="Red" BorderColor="#7F9DB9" 
                            Visible="False">
      <TABLE id="Table2" style="WIDTH: 600px; HEIGHT: 344px" cellSpacing="0" cellPadding="0"
								border="0">
								<TR>

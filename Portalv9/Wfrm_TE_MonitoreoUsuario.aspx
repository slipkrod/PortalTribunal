<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Masterpages/1.master" CodeBehind="Wfrm_TE_MonitoreoUsuario.aspx.vb" Inherits="Portalv9.Wfrm_TE_MonitoreoUsuario" %>
    ...
    DataSourceID="ObjectDataSource1" EnableTheming="False" 
        ...
        <Columns>
            <dxwgv:GridViewDataTextColumn Caption="Folio" FieldName="Folio_bolsa" 
                VisibleIndex="0" ToolTip="Folio de la Bolsa">
            ...
            <dxwgv:GridViewDataTextColumn Caption="No. Exp." FieldName="No_Expedientes" 
                VisibleIndex="2" ToolTip="Numero de Expedientes que contiene">
            </dxwgv:GridViewDataTextColumn>
            <dxwgv:GridViewDataTextColumn Caption="No. Docs." FieldName="No_Documentos" 
                VisibleIndex="3" ToolTip="Numero de Documentos que contiene">
            </dxwgv:GridViewDataTextColumn>
<dxwgv:GridViewDataTextColumn FieldName="Fecha_solicitud" Caption="Fecha" 
                VisibleIndex="4" ToolTip="Fecha de solicitud">
...
<asp:ObjectDataSource ID="ObjectDataSource1" runat="server" 
    SelectMethod="Monitoreo_TrasladosxUsuario" 
    TypeName="Portalv9.SAEX.ServiciosSAEX" 
        OldValuesParameterFormatString="original_{0}">
    <SelectParameters>
        <asp:Parameter DefaultValue="" Name="NoIdentidad" Type="Int32" />
    </SelectParameters>
    ...
    <dxwgv:ASPxGridView ID="ASPxGridView2" runat="server" 
        ...
        <Images ImageFolder="~/App_Themes/RedWine/{0}/">
         ...
         <Columns>
             ...
             <dxwgv:GridViewDataTextColumn Caption="Solicita" FieldName="Usuario_Solicita" 
                 VisibleIndex="5" ToolTip="Usuario que solicito">
             </dxwgv:GridViewDataTextColumn>
             <dxwgv:GridViewDataTextColumn Caption="Entidad" FieldName="Entidad" 
                 VisibleIndex="6" ToolTip="Entidad a la que pertenece">
             </dxwgv:GridViewDataTextColumn>
    ...
    <asp:ObjectDataSource ID="ObjectDataSource2" runat="server" 
        SelectMethod="Monitoreo_FoliosFaltantesxUsuario" 
        TypeName="Portalv9.SAEX.ServiciosSAEX">
        <SelectParameters>

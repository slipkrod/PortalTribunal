Public Partial Class CampoPeriodoMesAno
    ...
    Public Property TextoCampo() As String
        ...
        Set(ByVal value As String)
            Campo.Text = value
            vMes_ini.ValidationSettings.RequiredField.ErrorText = "* El mes inicial del campo " & value.Replace("*", "") & " es requerido"
            vMes_fin.ValidationSettings.RequiredField.ErrorText = "* El mes final del campo " & value.Replace("*", "") & " es requerido"
    ...
    Public Property Mes_Ini() As String
        Get
            Return vMes_ini.Value
        End Get
        Set(ByVal value As String)
            vMes_ini.Value = value
        End Set
    End Property
    Public Property Mes_Fin() As String
        Get
            Return vMes_fin.Value
        End Get
        Set(ByVal value As String)
            vMes_fin.Value = value
        End Set
    End Property
    ...
    Public Property ValorCampoObligatorio() As Boolean
        Get
            Return vMes_ini.ValidationSettings.RequiredField.IsRequired
        End Get
        Set(ByVal value As Boolean)
            vMes_ini.ValidationSettings.RequiredField.IsRequired = value
            vMes_fin.ValidationSettings.RequiredField.IsRequired = value

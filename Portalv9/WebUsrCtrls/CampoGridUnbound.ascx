<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="CampoGridUnbound.ascx.vb" Inherits="Portalv9.CampoGridUnbound" %>
                        ...
                        <table style="border: thin solid #C9D7DD; width: 100%; ">
                            ...
                            <tr>
                                <td style="width: 161px">Valor<dxe:ASPxLabel ID="lblidFolio" runat="server" 
                                        Value='<%# Bind("idFolio") %>' Visible="False">
                                    </dxe:ASPxLabel>
                                </td>
                                <td>                                    
                                    <dxe:ASPxSpinEdit ID="speValor" runat="server" AllowNull="False" 
                                        NumberType="Integer" Width="70px"
                                        ClientInstanceName="speValor" Number='<%# Bind("Valor") %>' ></dxe:ASPxSpinEdit>

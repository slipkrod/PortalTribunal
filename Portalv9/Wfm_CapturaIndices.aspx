<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Wfm_CapturaIndices.aspx.vb" Inherits="Portalv9.Wfm_CapturaIndices" %>
...
<body id="iframedBody" onload="resizeFrame()" style="background-color:White; background-image:none;">
            ...
            <table border="0" cellpadding="1" cellspacing="1" style="width: 100%; max-width:650px;" runat="server" id="tableIndices">
                <tr>
                    <td nowrap class="DataList_Aqua" >
                       <dxtc:ASPxPageControl ID="pgareas" runat="server" Width="650px" TabPosition="Top"   
                            style=" max-width:650; overflow:auto;" EnableTabScrolling="true" TabAlign="Justify">
	...
	resizeFrame();
                ...
                <tr>
                    <td>
                         <dxe:ASPxButton ID="aspxEditar" runat="server" style="height: 24px" Text="Editar" >

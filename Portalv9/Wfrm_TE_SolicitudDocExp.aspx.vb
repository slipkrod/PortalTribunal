...
Partial Public Class Wfrm_TE_SolicitudDocExp
    ...
    Private Sub GuardaDocumentos_Hijos(ByVal NewParentKey As Integer)
        ...
        If agregarnuevo = 0 Then
            ...
            For Each nNode As TreeListNode In list
                ...
                End If
                nNodoID = svr.ABC_Archivo_Descripciones(WSArchivo.OperacionesABC.operAlta, archivo, 0, "", nNode("idNivel"), nNode("idSerie"), "", 0, nNode("Serie_nombre"), 0, InstanciaPadre)
    ...
    End Sub
    Protected Sub btnagre_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnagre.Click
        agregarnuevo = 1
        btninc.Visible = False
        btnagre.Visible = False
        ASPxTreeList2.Visible = True
        lbldoc.Visible = True
    End Sub

    Protected Sub btninc_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btninc.Click
        agregarnuevo = 0
        btninc.Visible = False
        btnagre.Visible = False
        ASPxTreeList2.Visible = True

...
Partial Public Class Wfrm_Transferencia_Secundaria_Seleccionados_Cajas
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not IsPostBack Then
            Regresar.NavigateUrl = "Wfrm_Transferencia_Secundaria_Seleccionados.aspx?idArchivo=" & Request.QueryString("idArchivo") & _
                      ...
                      "&sTitulo=Valoración secundaria del archivo " & lblidArchivoOrigen.Text
    ...
    Protected Sub btnSelCaja_Click(ByVal sender As Object, ByVal e As EventArgs)
        ...
        CajasSel = sv.Lista_Transferencias_Secundarias_Documentos_CajasxidFolioDetalleDocumento(aspxtreeDocumentos.FocusedNode.DataItem("idFolioDetalleDocumento"))
    ...
    Protected Sub ASPxButton1_Click(ByVal sender As Object, ByVal e As EventArgs) Handles ASPxButton1.Click
        ...
        sv.ABC_Transferencias_Secundarias_Documentos_Cajas(1, aspxtreeDocumentos.FocusedNode.DataItem("idFolio"), 0, aspxtreeDocumentos.FocusedNode.DataItem("idFolioDetalle"), aspxtreeDocumentos.FocusedNode.DataItem("idFolioDetalleDocumento"))
        For iRow = 0 To gdCajasSel.VisibleRowCount - 1
            If gdCajasSel.Selection.IsRowSelected(iRow) Then
                sv.ABC_Transferencias_Secundarias_Documentos_Cajas(0, aspxtreeDocumentos.FocusedNode.DataItem("idFolio"), gdCajasSel.GetRowValues(iRow, "idFolioCaja"), aspxtreeDocumentos.FocusedNode.DataItem("idFolioDetalle"), aspxtreeDocumentos.FocusedNode.DataItem("idFolioDetalleDocumento"))
            End If
        Next
        gdCajasSel.Selection.UnselectAll()

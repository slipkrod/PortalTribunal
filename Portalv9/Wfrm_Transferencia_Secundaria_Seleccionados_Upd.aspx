<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Masterpages/Adminmaster2col.master" CodeBehind="Wfrm_Transferencia_Secundaria_Seleccionados_Upd.aspx.vb" Inherits="Portalv9.Wfrm_Transferencia_Secundaria_Seleccionados_Upd" %>
...
<br />
                ...
                <tr>
                    <td>
                        <asp:label id="Label5" runat="server" Font-Names="Arial" Font-Bold="True" 
                            Text="Archivo de Historico: "></asp:label>
                    </td>                        
                    <td>
            ...
            <td>
                <dxwgv:ASPxGridView ID="gdbuscadorBajas" runat="server" ClientInstanceName="grid" 
                    ...
                    <Columns>
                        ...
                        <dxwgv:GridViewDataCheckColumn Caption="Valor &lt;br/&gt;Informativo" 
                            FieldName="Valor_informativo" VisibleIndex="10">
                            <PropertiesCheckEdit ValueChecked="1" ValueType="System.Int32" 
                                ValueUnchecked="0">
                            </PropertiesCheckEdit>
                        </dxwgv:GridViewDataCheckColumn>
                        <dxwgv:GridViewDataCheckColumn Caption="Valor &lt;br/&gt;Testimonial" 
                            FieldName="Valor_testimonial" VisibleIndex="11">
                            <PropertiesCheckEdit ValueChecked="1" ValueType="System.Int32" 
                                ValueUnchecked="0">
                            </PropertiesCheckEdit>
                        </dxwgv:GridViewDataCheckColumn>
                        <dxwgv:GridViewDataCheckColumn Caption="Valor &lt;br/&gt;Evidencial" 
                            FieldName="Valor_evidencial" VisibleIndex="12">
                            <PropertiesCheckEdit ValueChecked="1" ValueType="System.Int32" 
                                ValueUnchecked="0">
                            </PropertiesCheckEdit>
                        </dxwgv:GridViewDataCheckColumn>
    ...
    <asp:ObjectDataSource ID="dsExpedientesTraspaso" runat="server" 
            SelectMethod="ListaVencimientos_Archivo_Concentracion_Seleccion" 
